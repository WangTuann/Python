...
class DSPhanSo:
    ...
    def SoSanhPhanSo(self, a: PhanSo,b: PhanSo):
        if(a.mau == b.mau):
            return a.tu<b.tu
        else:
...
ps.tu = 2
ps.mau = 3
dsps.readFile('/Users/qngtuann/STUDY/Python/lab2/PhanSo/phanso.txt')
print(f" Tong cac so am trong mang la : {dsps.TongPhanSoAm()}") 